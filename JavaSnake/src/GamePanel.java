...
public class GamePanel extends JPanel implements ActionListener {
    ...
    public void checkCollisions() {
        ...
        //checks if head collides with snakes body
        for (int i = bodyParts; i > 0; i--) {
            if ((x[0] == x[i]) && (y[0] == y[i])) {
                running = false;
            }
        ...
        //checks if head collides with wall (edge of screen)
        if (x[0] < 0) {
            running = false;
        }
    ...
    public void gameOver(Graphics g) {
        ...
        g.drawString("SCORE: " + applesEaten, (SCREEN_WIDTH - fm2.stringWidth("SCORE: " + applesEaten))/2, g.getFont().getSize());
